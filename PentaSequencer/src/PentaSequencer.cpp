...
struct PentaSequencer : Module {
	...
	PentaSequencer() {
		...
		configParam(KNOB1_PARAM, -5.f, 5.f, 0.f, "Knob 1");
		configParam(KNOB2_PARAM, -5.f, 5.f, 0.f, "Knob 2");
		configParam(KNOB3_PARAM, -5.f, 5.f, 0.f, "Knob 3");
		configParam(KNOB4_PARAM, -5.f, 5.f, 0.f, "Knob 4");
		configParam(KNOB5_PARAM, -5.f, 5.f, 0.f, "Knob 5");
		...
		configOutput(A_OUTPUT, "Output A");
		configOutput(B_OUTPUT, "Output B");
		configOutput(C_OUTPUT, "Output C");
		configOutput(D_OUTPUT, "Output D");
		configOutput(E_OUTPUT, "Output E");
